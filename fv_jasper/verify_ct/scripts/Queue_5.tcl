...
check_spv -create -from {io_enq_bits_corrupt io_enq_bits_data io_enq_bits_denied io_enq_bits_opcode io_enq_bits_size io_enq_bits_source} -to {io_deq_valid io_enq_ready}
prove -all