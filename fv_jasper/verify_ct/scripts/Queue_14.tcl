...
check_spv -create -from {io_enq_bits_addr io_enq_bits_burst io_enq_bits_echo_extra_id io_enq_bits_id io_enq_bits_len io_enq_bits_size} -to {io_deq_valid io_enq_ready}
prove -all